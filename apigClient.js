...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: 'us-east-1',
            apiKey: "eQrMgHdf9W5u0sS4g2qF8ayjJgfW00Pia6ikNA9t",
    ...
    var invokeUrl = 'https://zy3h7wbn21.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.rootGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['upload'], ['body']);
        
        var rootGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['upload']),
            body: body
        };
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['upload', 'ContentType'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['ContentType']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['upload', ]),
            body: body
        };
